...
![Realm SS](../../screenshots/z2_2_instasafe_realm.png)

-------------------------------------------------------------------------------------------------------------------------------------------------------------------------

**Keycloak Admin Console Showing Users:**

![Users SS](../../screenshots/z2_2_users.png)

-------------------------------------------------------------------------------------------------------------------------------------------------------------------------

**Keycloak Admin Console Showing SAML Type:**

![SAML Type SS](../../screenshots/z2_2_saml_type.png)
...
![clients SS](../../screenshots/z2_2_clients.png)

-------------------------------------------------------------------------------------------------------------------------------------------------------------------------

**Keycloak Admin Console Showing Mappers:**

![Mappers SS](../../screenshots/z2_2_attribute_mapper.png)

-------------------------------------------------------------------------------------------------------------------------------------------------------------------------

**Keycloak Admin Console Showing 'email' Mapper Configuration:**

![email Mapper Config SS](../../screenshots/z2_2_email_mapper.png)

-------------------------------------------------------------------------------------------------------------------------------------------------------------------------

**Keycloak Admin Console Showing 'groups' Mapper Configuration:**

![group Mapper Config SS](../../screenshots/z2_2_groups_mapper.png)

-------------------------------------------------------------------------------------------------------------------------------------------------------------------------

**Keycloak IdP Metadata Raw:**

![Metadata Raw SS](../../screenshots/z2_2_metadata_raw.png)

-------------------------------------------------------------------------------------------------------------------------------------------------------------------------

**Keycloak IdP Metadata Downloaded as .xml File:**

![Metadata Downloaded SS](../../screenshots/z2_2_metadata_xml_downloaded.png)

-------------------------------------------------------------------------------------------------------------------------------------------------------------------------

**'mail' Attribute found in Raw XML (Had to Use View Page Source First):**

!['mail' Attribute Found SS](../../screenshots/z2_2_email_attribute_found.png)
